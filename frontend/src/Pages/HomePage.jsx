      ...
      <nav className="bg-base-100/50 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          <SignInButton mode="modal">
            <button className="group hover:cursor-pointer px-6 py-3 bg-gradient-to-r from-primary via-secondary to-accent rounded-xl text-white font-semibold text-sm shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 flex items-center gap-2">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="badge badge-primary bg-lg">
